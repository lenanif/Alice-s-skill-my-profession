...
def create_speach(two_variants_id):
...
def handler(event, context = {}):
    ...
    if event['session']['new']:
        text = "Все профессии важны, все профессии нужны... Но какую выбрать? Я помогу вам и подскажу, куда можно пойти учиться. Для этого нужно пройти тест. Начинаем?" 
