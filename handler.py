...
def handler(event, context = {}):
    ...
    if event['session']['new']:
        text = "Все профессии важны, все профессии нужны... Но какую выбрать? \
        Я помогу вам определить свои сильные стороны и подскажу, куда можно пойти учиться. \
        Вам нужно пройти тест. В нем 20 вопросов. Начинаем?"
